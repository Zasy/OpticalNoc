...
set ylabel "Average optical loss (dB)" font "Helvetica,20" offset -1.8,0
set ytics ("5" 5, "10" 10, "15" 15, "20" 20, "25" 25, "30" 30) font "Helvetica,20"
set xrange [-0.7:3.7]
set yrange [3:35]
set grid ls 4
set grid noxtics
...
set tmargin 2
set bmargin 5
set key at 2.5,34.5 Left width -2
